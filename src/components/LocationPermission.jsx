    ...
    return (
        <div className="h-full w-full flex items-center justify-center bg-radar-bg relative overflow-hidden">
            ...
            <div className="relative z-10 text-center px-6 max-w-md animate-fade-in">
                <div className="w-24 h-24 mx-auto mb-8 rounded-full bg-gradient-to-br from-radar-accent/20 to-cyan-900/30 border-2 border-radar-accent/30 flex items-center justify-center animate-glow-pulse">
                    <span className="text-5xl">📍</span>
                </div>

                <h1 className="text-3xl font-bold mb-3 text-glow text-radar-accent font-mono">
                    GeoRadar
                </h1>
                ...
                <p className="text-sm text-radar-muted mb-8 leading-relaxed">
                    ...
                    <br />
                    <span className="text-radar-accent/70">Без регистрации • Без email • Без номера</span>
                </p>
                ...
                <div className="flex flex-col gap-3 items-center">
                    <button
                        ...
                        onClick={() => onAllow()}
                        className="btn-glow w-full max-w-[280px] px-8 py-3.5 rounded-xl bg-gradient-to-r from-radar-accent to-cyan-500 text-radar-bg font-semibold text-base transition-all hover:scale-105 active:scale-95 shadow-lg shadow-radar-accent/25"
                    >
